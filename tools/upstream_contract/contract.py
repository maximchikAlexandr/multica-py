    ...
    "types": frozenset(
        {
            ...
            "project_wire",
            "property_definition",
            "property_definition_wire",
            "property_definitions",
            "property_definitions_wire",
            "property_value",
            "property_value_wire",
            "property_values",
            "property_values_wire",
            "repository_mutation_result",
            ...
            "skill_files_wire",
            "skill_search_result",
            "skill_search_result_wire",
            "skill_search_results",
            "skill_search_results_wire",
            "skill_wire",
            "squad",
            "squad_member",
            "squad_members",
    ...
    "signatures": frozenset(
        {
            ...
            "agent_mcp_add_bound",
            "agent_mcp_disable",
            "agent_mcp_disable_bound",
            "agent_mcp_enable",
            "agent_mcp_enable_bound",
            "agent_mcp_list",
            "agent_mcp_remove",
            "agent_mcp_remove_bound",
            "agent_skills_list",
            "agent_skills_set",
            "agent_tasks",
    ...
    "decoders": frozenset(
        {
            ...
            "decode_property_definition",
            "decode_property_definitions",
            "decode_property_values",
            ...
            "decode_skill_file",
            "decode_skill_files",
            "decode_skill_search_result",
            "decode_skill_search_results",
            "decode_squad",
    ...
    "validators": frozenset(
        {
            ...
            "nonblank:body",
            "nonblank:comment_id",
            "nonblank:contribution_key",
            "nonblank:daemon_id",
            "nonblank:directory",
            "nonblank:endpoint",
            "nonblank:file_id",
            "nonblank:issue_id",
            "nonblank:installation_id",
            "nonblank:key",
            "nonblank:label_id",
            "nonblank:local_path",
            "nonblank:member_id",
