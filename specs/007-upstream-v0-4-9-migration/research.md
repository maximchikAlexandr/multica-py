...
Binding implementation authority is the compact contract set under
`contracts/`, plus `data-model.md`, `quickstart.md`, and `tasks.md`.
`HANDOFF.md` is historical context only and must not be used to choose behavior.
