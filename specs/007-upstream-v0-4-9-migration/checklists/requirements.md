...
- Planning continuation corrected the stale branch and historical blocker
  wording: the active branch is `upstream-v0-4-9-migration`; the remaining
  baseline defect is mandatory artifact wiring, not missing architecture files.
