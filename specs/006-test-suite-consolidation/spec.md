...
4. Снижение coverage, mutation score или обязательного behavior dimension блокирует merge.
...
- **FR-032:** Если stage gate падает после merge dedup-PR, дедупликация MUST останавливаться до revert этого PR или восстановления retained coverage; `tests/duplicate-removal-map.json` MUST служить источником восстановления.
