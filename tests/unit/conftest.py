...
from tools.live_support.environment import CompatibilityTarget, LiveSettings
...
def make_target(**overrides: object) -> CompatibilityTarget:
    ...
    return CompatibilityTarget(**kwargs)  # type: ignore[arg-type]
...
def make_settings(tmp_path: pathlib.Path, **overrides: object) -> LiveSettings:
    ...
    kwargs.update(**overrides)
    return LiveSettings(**kwargs)  # type: ignore[arg-type]
