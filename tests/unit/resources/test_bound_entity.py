...
_ENTITY_POLICY_CASES: tuple[EntityPolicyCase, ...] = (
    ...
    EntityPolicyCase(
        ...
        ("_client", "_issues", "_mcp_servers", "_skills", "_tasks", "_wire_presence"),
        (),
        (("skill_refs", "skills"),),
        (),
    ),
    EntityPolicyCase(
        Skill,
        ("id", "name", "description", "file_count", "content"),
        ("_client", "_files", "_labels", "_wire_presence"),
        (),
        (),
        (),
    ),
    ...
    EntityPolicyCase(
        Label,
        ("id", "name", "color", "description", "resource_type"),
        ("_client",),
        (),
        (),
        (),
