...
def _build_operation_cases() -> tuple[OperationCase, ...]:
    ...
    cases: list[OperationCase] = [
        ...
        _c(
            ...
            stdout=b'{"id":"tr_1","autopilot_id":"ap_1","kind":"schedule","enabled":true}',
        ...
        _c(
            ...
            stdout=b'{"id":"tr_001","autopilot_id":"ap_001","kind":"schedule","enabled":false}',
        ...
        _c(
            ...
            stdout=b'{"id":"tr_001","autopilot_id":"ap_001","kind":"schedule","enabled":true}',
        ...
        _c(
            ...
            args=("run_001",),
            kwargs=(("issue_id", "iss_001"), ("since", 42)),
            stdout=b"[]",
            id="manual:issues.run_messages:variant:01",
        ),
        _c(
            "issues.run_messages",
            (
            ...
            args=("run_001",),
            kwargs=(("issue_id", "iss_001"), ("since", 2147483647)),
            stdout=b"[]",
        ...
        _c(
            ...
            stdout=b'{"id":"tr1","autopilot_id":"ap1","kind":"schedule","enabled":true}',
