...
The current reviewed interval is `[0.4.42, 0.4.45)`. The direct migration
compares baseline `0.4.43` at source commit
`2ae2dbbb8f9ed9ffe1739ecf5abfe31a940ee50c` with target `0.4.44` at source
commit `c7f259c70a60bff30011c403fada79ab382f608a`; it does not publish an
intermediate SDK release. Retained operations support `0.4.42`, while safe
comment deletion requires `0.4.44`; `0.4.45` is exclusive.

The target release is GitHub release `389061637`, asset
`multica-cli-0.4.44-darwin-arm64.tar.gz`. Its official archive digest is
`f300cf8036b1f596466acde35f67d986f1f75a657f77e6e0e9de1134563a76aa`, its
extracted executable digest is
`ac26860e3f60ab6eafd4e7066d43d0fad2b0691adfefac339c4921e1dd68f774`, and its
version-output digest is
`bb8da8535a0e76c814f5e0d0e90450b315d15eca53ed4e60ca520cb6c22d21f1`.
...
The current v0.4.44 review uses these exact stages, in this order; collection
...
uv run python scripts/upstream_contract.py collect \
  --source-checkout /absolute/pinned/v0.4.44/source \
  --binary /absolute/verified/multica-cli-0.4.44 \
  --tag v0.4.44 --version 0.4.44 \
  --commit c7f259c70a60bff30011c403fada79ab382f608a \
  --release-id 389061637 --asset-name multica-cli-0.4.44-darwin-arm64.tar.gz \
  --sha256 ac26860e3f60ab6eafd4e7066d43d0fad2b0691adfefac339c4921e1dd68f774 \
