...
- **THEN** the sets are equal, with 117 unique canonical methods, 146 unique case IDs, and 29 noncanonical variants; 143 historic payload rows remain a migration subset.
