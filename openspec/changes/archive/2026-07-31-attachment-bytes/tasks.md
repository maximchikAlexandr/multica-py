...
- [x] 6.4 Add `test_upload_bytes_preserves_filename`: call `upload_bytes("i1", "consumer-result.json", b'...')`. Assert the `--file` argv value ends with `consumer-result.json` and `PurePath(...).name == "consumer-result.json"`.
